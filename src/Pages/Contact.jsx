      ...
      <div className="flex flex-col justify-center sm:flex-row gap-10 my-10 mb-28">
        ...
        <div className="flex flex-col justify-center items-start gap-4">
          ...
          <p className="text-gray-800">
            Tel: <span className="text-gray-500">+88 01758224633</span>
          </p>
          <p className=" text-gray-800">
            Email: <span className="text-gray-500">shahinshah.cs@gmail.com</span>
          </p>

          <p className="text-gray-500">Careers at LuxeLore</p>
          <p className="text-gray-500">
